...
export default function UserRegister() {
    ...
    let handleRegister = function (event) {
        if (password !== conf_pass) {
            ...
            let apiAddress = "http://127.0.0.1:5000/user-register";
            axios({
                method: "post",
                responseType: 'json',
                url: apiAddress,
    ...
    return (
        <div className="container">
            <ToastContainer />
            <div className="row g-0 auth-row mt-2">
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="input-style-1">
                                            <label>Name</label>
                                            <input type="text" placeholder="User's Name" maxLength={20} required value={name} onChange={(event) => setName(event.target.value)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-12">
                                        <div className="input-style-1">
                                            <label>Mobile</label>
                                            <input type="number" placeholder="Mobile No." maxLength="10" required value={mobile} onChange={(event) => setMobile(event.target.value)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
